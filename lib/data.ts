...
export const reports: Report[] = [
  {
    id: "rp1",
    name: "Báo cáo tổng quan tháng 2/2026",
  ...
  {
    id: "rp2",
    name: "Tiến độ nhiệm vụ - Website Redesign",
    type: "task-progress",
  ...
  {
    id: "rp5",
    name: "Báo cáo tiến độ - Mobile App v2.0",
    type: "task-progress",
